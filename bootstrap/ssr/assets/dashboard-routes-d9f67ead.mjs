...
import { aq as useMediaQuery, aB as getFromLocalStorage, aC as setInLocalStorage, aD as Underlay, c as createSvgIcon, az as Navbar, I as IconButton, a3 as getBootstrapData, m as message, M as getInputFieldClassNames, ai as useField, aj as Field, aE as useUserTimezone, a4 as useIsMobileMediaQuery, aF as useSelectedLocale, aG as useDateFormatter, u as useSettings, af as DateFormatPresets, aH as shallowEqual, y as List, z as ListItem, T as Trans, aI as useAutoFocus, d as useDialogContext, h as DialogFooter, B as Button, D as Dialog, f as DialogBody, p as DialogTrigger, a as apiClient, P as createEventHandler, aJ as useIsDarkMode, S as Skeleton, aK as Checkbox, b as useTrans, N as useNumberFormatter, a5 as SelectForwardRef, J as Item, aL as hasNextPage, aM as ArrowDropDownIcon, H as FormSelect, aN as AvatarPlaceholderIcon, n as Tooltip, E as opacityAnimation, g as FormTextField, k as Chip, aO as useListbox, aP as Listbox, aQ as Popover, X as ProgressCircle, aR as KeyboardArrowDownIcon, aS as useListboxKeyboardNavigation, e as DialogHeader, F as Form, A as TextField, ao as SearchIcon, at as FormattedNumber, j as CloseIcon, a6 as ProgressBar, U as StaticPageTitle, q as queryClient, t as toast, s as showHttpErrorToast, r as ConfirmationDialog, Y as IllustratedMessage, Z as SvgImage, Q as ButtonBase, aT as UploadedFile, O as clamp, aU as WorkspaceQueryKeys, o as onFormQueryError, aV as useActiveWorkspaceId, aW as useAuth, aX as PersonalWorkspace, w as useValueLists, aY as ExitToAppIcon, a9 as MenuTrigger, aa as Menu, aZ as useUserWorkspaces, a_ as openDialog, i as CheckIcon, a$ as ProgressBarBase, l as FormattedDate, C as CustomMenu, b0 as AdHost, aA as Footer$1, b1 as useThemeSelector, ab as RemoteFavicon, a1 as LinkStyle, ac as removeProtocol, b2 as lazyLoader, b3 as prefetchValueLists, b4 as LockIcon, V as FileUploadProvider, v as FormImageSelector, b5 as SettingsIcon, a7 as LinkIcon, b6 as urlIsValid, b7 as removeEmptyValuesFromObject, b8 as useRecaptcha, b9 as LinkClipboardButton, ba as ShareLinkButton, bb as shareLink, _ as useNavigate$1, bc as WarningIcon, a2 as SiteConfigContext, bd as FloatingLinkOverlay, a0 as FullPageLoader, be as ImageIcon, bf as SocialsList, bg as parse, bh as WidgetRenderers, bi as BiolinkLayout, bj as RadioGroup, bk as Radio, bl as cssPropsFromBgConfig, bm as useCollator, bn as loadFonts, bo as notifySvg, bp as useActiveUpload, bq as UploadInputType, br as Disk, av as PageMetaTags, aw as PageStatus, ax as AuthRoute, ay as NotFoundPage } from "../server-entry.mjs";
...
import { E as EditIcon, M as MoreHorizIcon, B as Breadcrumb, a as BreadcrumbItem } from "./Edit-18dc9207.mjs";
...
const AceEditor = React.lazy(() => import("./ace-editor-b03b8132.mjs"));
function AceDialog({
  defaultValue,
  mode = "html",
  title,
...
function UpgradeDialog({ message: message2, messageSuffix }) {
  ...
  return /* @__PURE__ */ jsxs(Dialog, { size: "sm", children: [
    ...
    /* @__PURE__ */ jsxs(DialogBody, { children: [
      /* @__PURE__ */ jsx("div", { className: "text-center mb-20", children: /* @__PURE__ */ jsx(SvgImage, { src: upgradeSvg, className: "h-100 mx-auto" }) }),
      /* @__PURE__ */ jsxs("div", { children: [
        message2,
        " ",
        messageSuffix
...
function NoPermissionButton({ message: message2, className }) {
  const { billing } = useSettings();
  if (!billing.enable) {
    return /* @__PURE__ */ jsx(GenericButton, {});
  }
  return /* @__PURE__ */ jsxs(DialogTrigger, { type: "popover", children: [
    /* @__PURE__ */ jsx(
      Button,
...
function GenericButton() {
  return /* @__PURE__ */ jsx(
    Tooltip,
    {
      ...
      children: /* @__PURE__ */ jsx(LockIcon, { size: "sm", className: "text-muted" })
    }
  );
}
function LinkFormSection({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "border-t pt-24", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "text-muted text-sm", children: description }),
    children
  ] });
}
...
function ScheduleFields({ linkName }) {
  ...
  return /* @__PURE__ */ jsx(
    LinkFormSection,
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "block md:flex items-center gap-24 mt-24", children: [
        /* @__PURE__ */ jsx(
          FormDatePicker,
          {
...
function AliasField({ form, name }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mb-24", children: [
    ...
    aliasError && /* @__PURE__ */ jsx("div", { className: "text-xs text-danger mt-6", children: aliasError })
  ] });
}
...
function CrupdateLinkOverlayForm({
  ...
  return /* @__PURE__ */ jsxs(Form, { form, onSubmit, className: "flex h-full", children: [
    /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 w-full md:w-288 px-16 md:border-r md:shadow-lg h-full overflow-y-auto", children: /* @__PURE__ */ jsxs(Tabs, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-auto relative hidden md:block", children: [
...
function ColorField({ name, children }) {
  ...
  return /* @__PURE__ */ jsxs(
    DialogTrigger,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs(ButtonBase, { className: "flex items-center gap-10 w-full rounded border text-sm h-54 px-14 mb-10 bg relative hover:bg-hover", children: [
          /* @__PURE__ */ jsx(
            ColorIcon,
            {
              viewBox: "0 0 48 48",
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(
      FormSelect,
      {
        ...
        className: "mb-24",
        children: LinkOverlayPositions.map((position) => /* @__PURE__ */ jsx(Item, { value: position.key, children: /* @__PURE__ */ jsx(Trans, { ...position.label }) }, position.key))
      }
    ),
    /* @__PURE__ */ jsx(
      FormSelect,
    ...
    setBiolink: (biolink) => {
      set((state) => {
        ...
        if (!state.appearanceIsDirty) {
          state.appearance = ((_a2 = biolink.appearance) == null ? void 0 : _a2.config) || null;
        }
      });
    },
...
function LivePreview() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex-shrink-0 sticky top-24 h-max", children: [
    /* @__PURE__ */ jsx(
      Chip,
      {
        size: "sm",
    ...
    /* @__PURE__ */ jsx(PhoneSkeleton, { children: biolink ? /* @__PURE__ */ jsx(BiolinkLayout, { biolink, appearance }) : null }),
    /* @__PURE__ */ jsx("div", { className: "text-sm text-muted text-center mt-14", children: /* @__PURE__ */ jsx(Trans, { message: "Scheduled and disabled content is not shown" }) })
  ] });
}
function PhoneSkeleton({ children }) {
  return /* @__PURE__ */ jsx("div", { className: "w-350 h-[724px] rounded-[64px] shadow-lg border border-[#444546] border-[12px] overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "overflow-y-auto h-full compact-scrollbar", children }) });
}
...
function ColorBackgroundTab({
  ...
  return /* @__PURE__ */ jsxs("div", { className, children: [
    /* @__PURE__ */ jsx(CustomColorButton, { value, onChange }),
...
function CustomColorButton({
  ...
  return /* @__PURE__ */ jsxs(
    DialogTrigger,
    {
      ...
      onClose: (newValue) => {
        onChange == null ? void 0 : onChange(
          typeof newValue === "string" ? { ...BaseColorBg, backgroundColor: newValue } : newValue
        );
      },
      children: [
        /* @__PURE__ */ jsx(
          BackgroundSelectorButton,
          {
            ...
            children: /* @__PURE__ */ jsx("span", { className: "inline-block text-white bg-black/20 rounded p-10", children: /* @__PURE__ */ jsx(FormatColorFillIcon, { size: "lg" }) })
          }
        ),
        /* @__PURE__ */ jsx(
          ColorPickerDialog,
          {
            defaultValue: value == null ? void 0 : value.backgroundColor,
            onChange: (newColor) => {
              onChange == null ? void 0 : onChange({
                ...BaseColorBg,
...
function GradientBackgroundTab({
  ...
  return /* @__PURE__ */ jsxs("div", { className, children: [
    /* @__PURE__ */ jsx(CustomGradientButton, { value, onChange }),
...
function CustomGradientButton({
  ...
  return /* @__PURE__ */ jsxs(
    DialogTrigger,
    {
      ...
      onClose: (gradient) => {
        onChange == null ? void 0 : onChange(gradient);
      },
      children: [
        /* @__PURE__ */ jsx(
          BackgroundSelectorButton,
...
function CustomGradientDialog({
  ...
  const [state, setLocalState] = useState(() => {
    var _a2;
    const parts = ((_a2 = defaultValue == null ? void 0 : defaultValue.backgroundImage) == null ? void 0 : _a2.match(/\(([0-9]+deg),.?(.+?),.?(.+?)\)/)) || [];
    return {
      angle: parts[1] || "45deg",
...
function ColorPickerButton({
  ...
  return /* @__PURE__ */ jsxs(DialogTrigger, { type: "popover", children: [
    ...
    /* @__PURE__ */ jsx(ColorPickerDialog, { defaultValue: value, onChange, hideFooter: true })
  ] });
}
...
function BackgroundPositionSelector({
  ...
  return /* @__PURE__ */ jsx("div", { className: "border-t mt-20 pt-14", children: /* @__PURE__ */ jsx(RadioGroup, { size: "sm", disabled: !imageBgValue, children: Object.entries(BackgroundPositions).map(([key, position]) => {
    return /* @__PURE__ */ jsx(
      Radio,
      {
...
function ImageBackgroundTab({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs("div", { className, children: [
      /* @__PURE__ */ jsx(CustomImageTrigger, { value, onChange }),
    ...
    /* @__PURE__ */ jsx(BackgroundPositionSelector, { value, onChange })
  ] });
}
function CustomImageTrigger({ value, onChange }) {
      ...
      children: [
        /* @__PURE__ */ jsx(
          BackgroundSelectorButton,
          {
            ...
            isActive: (value == null ? void 0 : value.id) === BaseImageBg.id,
            className: "border-dashed border-2",
            style: cssPropsFromBgConfig(value),
            children: /* @__PURE__ */ jsx("span", { className: "inline-block text-white bg-black/20 rounded p-10", children: /* @__PURE__ */ jsx(UploadIcon, { size: "lg" }) })
          }
        ),
        /* @__PURE__ */ jsx(CustomImageDialog, { value })
      ]
    }
  );
}
function CustomImageDialog({ value }) {
  var _a2;
  const defaultValue = (_a2 = value == null ? void 0 : value.backgroundImage) == null ? void 0 : _a2.replace("url(", "").replace(")", "");
  const form = useForm({
...
function BackgroundSelector({ className }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className, children: [
    ...
    /* @__PURE__ */ jsx(
      Tab2,
      {
        value: activeTab === (value == null ? void 0 : value.type) ? value : void 0,
        onChange: (newValue) => {
...
function TypeSelector({ activeTab, onTabChange }) {
  return /* @__PURE__ */ jsxs("div", { className: "my-20 flex items-center gap-20 border-b pb-20", children: [
    /* @__PURE__ */ jsx(
      TypeButton,
      {
...
function BiolinkAppearanceEditor() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(BackgroundSelector, {}),
...
function AddNewLinkButton() {
  ...
  const position = biolink == null ? void 0 : biolink.content.filter((x) => x.pinned).length;
  return /* @__PURE__ */ jsxs(DialogTrigger, { type: "modal", children: [
...
const ArticleBodyEditor$1 = React.lazy(
  () => import("./article-body-editor-e6614b54.mjs")
);
...
export {
  ...
  NameWithAvatar as N,
  ChipField as O,
  useCurrentDateTime as P,
  SectionHelper as Q,
  useStickySentinel as R,
  Switch as S,
  TuneIcon as T,
  DatatableDataQueryKey as U,
  useNormalizedModels as V,
  Avatar as W,
  DataTable as X,
  useDataTable as Y,
  slugifyString as Z,
  downloadFileFromUrl as _,
  DashboardNavbar as a,
  dashboardRoutes as a$,
  USER_MODEL as a0,
  timestampFilter as a1,
  FormNormalizedModelField as a2,
  LineChart as a3,
  PolarAreaChart as a4,
  BarChart as a5,
  GeoChart as a6,
  DateRangePresets as a7,
  ReportDateSelector as a8,
  ClicksReportCharts as a9,
  ...
  SwapVertIcon as aU,
  UndoIcon as aV,
  UnfoldLessIcon as aW,
  UnfoldMoreIcon as aX,
  UploadIcon as aY,
  WidgetsIcon as aZ,
  useFilter as a_,
  SharedDashboardRoutes as aa,
  ArticleEditorStickyHeader as ab,
  ArticleEditorTitle as ac,
  FontSelector$1 as ad,
...
//# sourceMappingURL=dashboard-routes-d9f67ead.mjs.map
