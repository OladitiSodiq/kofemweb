...
import React, { forwardRef, memo, createContext, useContext, useMemo, Fragment, isValidElement, cloneElement, useCallback, useState, useEffect, useRef, useId, Children, createElement } from "react";
...
const BillingPageRoutes = React.lazy(
  () => import("./assets/billing-page-routes-98918f88.mjs")
);
const CheckoutRoutes = React.lazy(() => import("./assets/checkout-routes-11d490bd.mjs"));
...
function LinkButton({ link: link2, appearance }) {
  ...
  const buttonColor = ((_d = appearance == null ? void 0 : appearance.btnConfig) == null ? void 0 : _d.color) ?? "primary";
  ...
  return /* @__PURE__ */ jsx(
    Button,
    {
      className: clsx(
        ...
        link2.animation && `animate__animated animate__${link2.animation}`
      ),
      variant,
      radius,
      color: !isCustomBgColor ? buttonColor : null,
      startIcon: link2.image ? /* @__PURE__ */ jsx(
        "img",
        {
      ...
      style: {
        boxShadow: shadow,
        backgroundColor: isCustomBgColor ? buttonColor : void 0,
...
const AdminRoutes = React.lazy(() => import("./assets/admin-routes-8cfb6ea5.mjs").then((n) => n.h));
const SwaggerApiDocs = React.lazy(
  () => import("./assets/swagger-api-docs-page-1bdc2626.mjs")
);
const DashboardRoutes = React.lazy(
  () => import("./assets/dashboard-routes-d9f67ead.mjs").then((n) => n.a$)
);
function AppRoutes() {
  var _a;
...
export {
  ...
  CustomMenu as C,
  Dialog as D,
  opacityAnimation as E,
  Form as F,
  createSvgIconFromTree as G,
  FormSelect as H,
  IconButton as I,
  Item$1 as J,
  Section as K,
  ...
  useNumberFormatter as N,
  clamp as O,
  createEventHandler as P,
  ButtonBase as Q,
  MixedText as R,
  Skeleton as S,
  Trans as T,
  StaticPageTitle as U,
  FileUploadProvider as V,
  useAppearanceEditorMode as W,
  ProgressCircle as X,
  IllustratedMessage as Y,
  SvgImage as Z,
  useNavigate as _,
  apiClient as a,
  ProgressBarBase as a$,
  FullPageLoader as a0,
  LinkStyle as a1,
  SiteConfigContext as a2,
  getBootstrapData as a3,
  useIsMobileMediaQuery as a4,
  SelectForwardRef as a5,
  ProgressBar as a6,
  LinkIcon as a7,
  ExternalLink as a8,
  MenuTrigger as a9,
  Footer as aA,
  getFromLocalStorage as aB,
  setInLocalStorage as aC,
  Underlay as aD,
  useUserTimezone as aE,
  useSelectedLocale as aF,
  useDateFormatter as aG,
  shallowEqual as aH,
  useAutoFocus as aI,
  useIsDarkMode as aJ,
  Checkbox as aK,
  hasNextPage as aL,
  ArrowDropDownIcon as aM,
  AvatarPlaceholderIcon as aN,
  useListbox as aO,
  Listbox as aP,
  Popover as aQ,
  KeyboardArrowDownIcon as aR,
  useListboxKeyboardNavigation as aS,
  UploadedFile as aT,
  ...
  useMediaQuery as aq,
  useProducts as ar,
  FormattedPrice as as,
  FormattedNumber as at,
  useCustomPage as au,
  PageMetaTags as av,
  PageStatus as aw,
  AuthRoute as ax,
  ...
  TabletIcon as b$,
  AdHost as b0,
  useThemeSelector as b1,
  lazyLoader as b2,
  prefetchValueLists as b3,
  LockIcon as b4,
  SettingsIcon as b5,
  urlIsValid as b6,
  removeEmptyValuesFromObject as b7,
  useRecaptcha as b8,
  LinkClipboardButton as b9,
  AccountCircleIcon as bA,
  AddAPhotoIcon as bB,
  ApiIcon as bC,
  CheckBoxOutlineBlankIcon as bD,
  CheckCircleIcon as bE,
  ComputerIcon as bF,
  DangerousIcon as bG,
  DarkModeIcon as bH,
  DevicesIcon as bI,
  ...
  PeopleIcon as bV,
  PersonIcon as bW,
  PhonelinkLockIcon as bX,
  QrCode2Icon as bY,
  ShareIcon as bZ,
  SmartphoneIcon as b_,
  ShareLinkButton as ba,
  shareLink as bb,
  WarningIcon as bc,
  FloatingLinkOverlay as bd,
  ImageIcon as be,
  SocialsList as bf,
  parse as bg,
  WidgetRenderers as bh,
  BiolinkLayout as bi,
  RadioGroup as bj,
  Radio as bk,
  cssPropsFromBgConfig as bl,
  useCollator as bm,
  loadFonts as bn,
  notifySvg as bo,
  useActiveUpload as bp,
  UploadInputType as bq,
  Disk as br,
